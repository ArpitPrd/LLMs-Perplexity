...
class PerplexityForMe(Perplexity):
    def _compute(
...
if __name__ == '__main__':
    model = AutoModelForCausalLM.from_pretrained("llama-2-7b", local_files_only=True)
    tokenzier = AutoTokenizer.from_pretrained("llama-2-7b")
    perplexity = evaluate.load("perplexity", module_type="metric")
    input_texts = ["lorem ipsum", "Happy Birthday!", "Bienvenue"]
